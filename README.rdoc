...
== Install Solr
   using these instructions: https://groups.google.com/forum/?fromgroups=#!topic/ruby-sunspot/c6OVesLyaSI

== To start solr
   bundle exec rake sunspot:solr:start

== To reindex
   rake sunspot:solr:reindex   (without bundle exec)

== Sample search   
   Product.search { fulltext "מלפפון" }.results